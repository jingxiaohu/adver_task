...
public class Request_params_logDao extends BaseDao{
    ...
    private  String[] carrays ={"id","method_name","duration","params_json","reponse_json","ctime","note"};
    private  String coulmns ="id,method_name,duration,params_json,reponse_json,ctime,note";
    private  String coulmns2 ="method_name,duration,params_json,reponse_json,ctime,note";
    ...
    public int insert(Request_params_log bean, String TABLENAME2) throws SQLException{
        String sql;
        try{
            sql = "INSERT INTO "+TABLENAME2+" (method_name,duration,params_json,reponse_json,ctime,note) VALUES (:method_name,:duration,:params_json,:reponse_json,:ctime,:note)";
    ...
    public int insert_primarykey(Request_params_log bean, String TABLENAME2) throws SQLException{
        String sql;
        try{
            sql = "INSERT INTO "+TABLENAME2+" (id,method_name,duration,params_json,reponse_json,ctime,note) VALUES (:id,:method_name,:duration,:params_json,:reponse_json,:ctime,:note)";
            SqlParameterSource ps = new BeanPropertySqlParameterSource(bean);
    ...
    public int[] insert(final List<Request_params_log> beans, String TABLENAME2) throws SQLException{
        String sql;
        try{
            sql = "INSERT INTO "+TABLENAME2+" (method_name,duration,params_json,reponse_json,ctime,note) VALUES (?,?,?,?,?,?)";
            return _np.getJdbcOperations().batchUpdate(sql, new BatchPreparedStatementSetter() {
                ...
                public void setValues(PreparedStatement ps, int i) throws SQLException {
                    ...
                    ps.setString(4, bean.reponse_json);
    ...
    public List<Request_params_log> selectAll(String TABLENAME2) {
        String sql;
        try{
            sql = "SELECT id,method_name,duration,params_json,reponse_json,ctime,note FROM "+TABLENAME2+" ORDER BY id";
    ...
    public List<Request_params_log> selectLast(int num ,String TABLENAME2) {
        String sql;
        try{
            sql = "SELECT id,method_name,duration,params_json,reponse_json,ctime,note FROM "+TABLENAME2+" ORDER BY id DESC LIMIT "+num+"" ;
            return _np.getJdbcOperations().query(sql, new BeanPropertyRowMapper<Request_params_log>(Request_params_log.class));
        }catch(Exception e){
            //createTable(TABLENAME2);
    ...
    public List<Request_params_log> selectGtKey(long id, String TABLENAME2) {
        String sql;
        try{
            sql="SELECT id,method_name,duration,params_json,reponse_json,ctime,note FROM "+TABLENAME2+" WHERE id>:id";
    ...
    public List<Request_params_log> selectByPage(int begin, int num, String TABLENAME2) {
        try{
            String sql;
            sql = "SELECT id,method_name,duration,params_json,reponse_json,ctime,note FROM "+TABLENAME2+" LIMIT "+begin+", "+num+"";
            return _np.getJdbcOperations().query(sql,new BeanPropertyRowMapper<Request_params_log>(Request_params_log.class));
        }catch(Exception e){
            //createTable(TABLENAME2);
    ...
    public int updateByKey(Request_params_log bean, String TABLENAME2) {
        try{
            String sql;
            sql = "UPDATE "+TABLENAME2+" SET method_name=:method_name,duration=:duration,params_json=:params_json,reponse_json=:reponse_json,ctime=:ctime,note=:note WHERE id=:id";
            SqlParameterSource ps = new BeanPropertySqlParameterSource(bean);
            return _np.update(sql, ps);
        }catch(Exception e){
    ...
    public int[] updateByKey (final List<Request_params_log> beans, String TABLENAME2) throws SQLException{
        try{
            String sql;
            sql = "UPDATE "+TABLENAME2+" SET method_name=?,duration=?,params_json=?,reponse_json=?,ctime=?,note=? WHERE id=?";
            return _np.getJdbcOperations().batchUpdate(sql, new BatchPreparedStatementSetter() {
                //@Override
                public int getBatchSize() {
                    return beans.size();
    ...
    public void createTable(String TABLENAME2) throws SQLException{
        try{
            ...
            sql = "CREATE TABLE IF NOT EXISTS `${TABLENAME}` (" +
                 ...
                 "	`params_json`  TINYTEXT COMMENT '//text    请求参数JSON字符串'," +
                 "	`reponse_json`  TINYTEXT COMMENT '//text    返回数据JSON字符串'," +
