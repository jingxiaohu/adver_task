...
public class User_vc_actDao extends BaseDao{
    ...
    private  String[] carrays ={"id","ui_id","order_id","order_type","act_type","money","ctime","state","is_add","act_name","note","tel","ui_nd","pay_source","upc_id","discount_type","discount_money"};
    private  String coulmns ="id,ui_id,order_id,order_type,act_type,money,ctime,state,is_add,act_name,note,tel,ui_nd,pay_source,upc_id,discount_type,discount_money";
    private  String coulmns2 ="ui_id,order_id,order_type,act_type,money,ctime,state,is_add,act_name,note,tel,ui_nd,pay_source,upc_id,discount_type,discount_money";
    ...
    public int insert(User_vc_act bean, String TABLENAME2) throws SQLException{
        String sql;
        try{
            sql = "INSERT INTO "+TABLENAME2+" (ui_id,order_id,order_type,act_type,money,ctime,state,is_add,act_name,note,tel,ui_nd,pay_source,upc_id,discount_type,discount_money) VALUES (:ui_id,:order_id,:order_type,:act_type,:money,:ctime,:state,:is_add,:act_name,:note,:tel,:ui_nd,:pay_source,:upc_id,:discount_type,:discount_money)";
    ...
    public int insert_primarykey(User_vc_act bean, String TABLENAME2) throws SQLException{
        String sql;
        try{
            sql = "INSERT INTO "+TABLENAME2+" (id,ui_id,order_id,order_type,act_type,money,ctime,state,is_add,act_name,note,tel,ui_nd,pay_source,upc_id,discount_type,discount_money) VALUES (:id,:ui_id,:order_id,:order_type,:act_type,:money,:ctime,:state,:is_add,:act_name,:note,:tel,:ui_nd,:pay_source,:upc_id,:discount_type,:discount_money)";
            SqlParameterSource ps = new BeanPropertySqlParameterSource(bean);
    ...
    public int[] insert(final List<User_vc_act> beans, String TABLENAME2) throws SQLException{
        String sql;
        try{
            sql = "INSERT INTO "+TABLENAME2+" (ui_id,order_id,order_type,act_type,money,ctime,state,is_add,act_name,note,tel,ui_nd,pay_source,upc_id,discount_type,discount_money) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
    ...
    public List<User_vc_act> selectAll(String TABLENAME2) {
        String sql;
        try{
            sql = "SELECT id,ui_id,order_id,order_type,act_type,money,ctime,state,is_add,act_name,note,tel,ui_nd,pay_source,upc_id,discount_type,discount_money FROM "+TABLENAME2+" ORDER BY id";
    ...
    public List<User_vc_act> selectLast(int num ,String TABLENAME2) {
        String sql;
        try{
            sql = "SELECT id,ui_id,order_id,order_type,act_type,money,ctime,state,is_add,act_name,note,tel,ui_nd,pay_source,upc_id,discount_type,discount_money FROM "+TABLENAME2+" ORDER BY id DESC LIMIT "+num+"" ;
            return _np.getJdbcOperations().query(sql, new BeanPropertyRowMapper<User_vc_act>(User_vc_act.class));
        }catch(Exception e){
            //createTable(TABLENAME2);
    ...
    public List<User_vc_act> selectGtKey(long id, String TABLENAME2) {
        String sql;
        try{
            sql="SELECT id,ui_id,order_id,order_type,act_type,money,ctime,state,is_add,act_name,note,tel,ui_nd,pay_source,upc_id,discount_type,discount_money FROM "+TABLENAME2+" WHERE id>:id";
    ...
    public List<User_vc_act> selectByPage(int begin, int num, String TABLENAME2) {
        try{
            String sql;
            sql = "SELECT id,ui_id,order_id,order_type,act_type,money,ctime,state,is_add,act_name,note,tel,ui_nd,pay_source,upc_id,discount_type,discount_money FROM "+TABLENAME2+" LIMIT "+begin+", "+num+"";
            return _np.getJdbcOperations().query(sql,new BeanPropertyRowMapper<User_vc_act>(User_vc_act.class));
        }catch(Exception e){
            //createTable(TABLENAME2);
    ...
    public int updateByKey(User_vc_act bean, String TABLENAME2) {
        try{
            String sql;
            sql = "UPDATE "+TABLENAME2+" SET ui_id=:ui_id,order_id=:order_id,order_type=:order_type,act_type=:act_type,money=:money,ctime=:ctime,state=:state,is_add=:is_add,act_name=:act_name,note=:note,tel=:tel,ui_nd=:ui_nd,pay_source=:pay_source,upc_id=:upc_id,discount_type=:discount_type,discount_money=:discount_money WHERE id=:id";
            SqlParameterSource ps = new BeanPropertySqlParameterSource(bean);
            return _np.update(sql, ps);
        }catch(Exception e){
    ...
    public int[] updateByKey (final List<User_vc_act> beans, String TABLENAME2) throws SQLException{
        try{
            String sql;
            sql = "UPDATE "+TABLENAME2+" SET ui_id=?,order_id=?,order_type=?,act_type=?,money=?,ctime=?,state=?,is_add=?,act_name=?,note=?,tel=?,ui_nd=?,pay_source=?,upc_id=?,discount_type=?,discount_money=? WHERE id=?";
            return _np.getJdbcOperations().batchUpdate(sql, new BatchPreparedStatementSetter() {
                //@Override
                public int getBatchSize() {
                    return beans.size();
