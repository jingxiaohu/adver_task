...
public class Write_applyUserAction extends BaseV1Controller {
   ...
   * 申请成为推荐合作人
   */
  @RequestMapping(value = "/goods/apply_user")
  @ResponseBody
  public String apply_user(HttpServletRequest request, HttpServletResponse response, Param_userinfo param) {
