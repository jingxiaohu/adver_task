...
import com.alipay.config.AlipayConfig_PC;
...
public class ZFB_PayPc2Action extends BaseV1Controller {
  ...
  @RequestMapping(value = "/zfb_charge_pc")
  @ResponseBody
...
//        String sign = AlipaySignature.rsaSign(params, APP_PRIVATE_KEY, "UTF-8");
        ...
        //获得初始化的AlipayClient
        AlipayClient alipayClient = new DefaultAlipayClient(AlipayConfig_PC.gatewayUrl, AlipayConfig_PC.app_id, AlipayConfig_PC.merchant_private_key, "json", AlipayConfig_PC.charset, AlipayConfig_PC.alipay_public_key, AlipayConfig_PC.sign_type);

        //设置请求参数
        AlipayTradePagePayRequest alipayRequest = new AlipayTradePagePayRequest();
        alipayRequest.setReturnUrl(AlipayConfig_PC.return_url);
        alipayRequest.setNotifyUrl(AlipayConfig_PC.notify_url);
        alipayRequest.setBizContent(JSON.toJSONString(appbean));
       //请求
