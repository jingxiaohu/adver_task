...
public class test2 extends BaseV1Controller {
    ...
    public void kuaidi(HttpServletRequest request, HttpServletResponse response, @Param("EBusinessID")String EBusinessID
    ,String PushTime,String count,String Data
    ) {
