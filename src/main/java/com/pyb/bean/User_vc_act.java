...
public class User_vc_act implements Cloneable , Serializable{
    ...
    //public static String[] carrays ={"id","ui_id","order_id","order_type","act_type","money","ctime","state","is_add","act_name","note","tel","ui_nd","pay_source","upc_id","discount_type","discount_money"};
    ...
    public static User_vc_act newUser_vc_act(long id, long ui_id, String order_id, int order_type, int act_type, int money, java.util.Date ctime, int state, int is_add, String act_name, String note, String tel, String ui_nd, int pay_source, long upc_id, int discount_type, int discount_money) {
