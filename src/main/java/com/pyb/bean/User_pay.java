...
public class User_pay implements Cloneable , Serializable{
    ...
    public static User_pay newUser_pay(long id, String order_id, String transaction_id, int type, int version_code, int system_type, String return_url, long ui_id, String ui_nd, String tel, long money, int act_type, java.util.Date ctime, java.util.Date utime, java.util.Date etime, int state, String ip, String referer, String subject, String car_order_id, String note) {
