...
public class Sms_running implements Cloneable , Serializable{
    ...
    //public static String[] carrays ={"Id","sms_tel","sms_content","sms_stat","sms_type","sms_user","sms_user_name","server_state","sms_date","note","sv_id"};

    public int Id;//int(11)    
    public String sms_tel="";//varchar(255)    电话或者邮箱
    public String sms_content="";//text    消息内容
    public int sms_stat;//int(11)    失败还是成功，0：失败1：成功
    public int sms_type;//int(11)    0-程序员自定义短信1-自定义短信2:邮箱
    public String sms_user="";//varchar(60)    发送用户
    public String sms_user_name="";//varchar(60)    发送用户
    public String server_state="";//varchar(255)    服务端的状态码
    public String sms_date="";//varchar(40)    发送时间
    public String note="";//varchar(255)    备注
    public long sv_id;//bigint(20)    sms_validate表的主键ID
    ...
    public void setSv_id(long value){
        this.sv_id= value;
    }



    public static Sms_running newSms_running(int Id, String sms_tel, String sms_content, int sms_stat, int sms_type, String sms_user, String sms_user_name, String server_state, String sms_date, String note, long sv_id) {
    ...
    public void assignment(Sms_running sms_running) {
        ...
        long sv_id = sms_running.getSv_id();
