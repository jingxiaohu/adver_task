...
public class Sms_validate implements Cloneable , Serializable{
    ...
    //public static String[] carrays ={"id","v_tel","v_code","v_list","v_class","v_time","v_time_str","note","type"};
    ...
    public int type;//int(11)    类型（0:未指定1:邮箱2:手机）
    ...
    public static Sms_validate newSms_validate(long id, String v_tel, String v_code, String v_list, String v_class, long v_time, String v_time_str, String note, int type) {
