...
public class Request_params_log implements Cloneable , Serializable{
    ...
    //public static String[] carrays ={"id","method_name","duration","params_json","reponse_json","ctime","note"};
    ...
    public static Request_params_log newRequest_params_log(long id, String method_name, long duration, String params_json, String reponse_json, java.util.Date ctime, String note) {
