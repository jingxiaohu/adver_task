...
public class AlipaySubmit {
    ...
    // 支付宝网关
    public static String ALIPAY_GATEWAY_PC = "https://openapi.alipay.com/gateway.do?";
     ...
     * @return 提交表单HTML文本
     */
    public static String buildRequestget_PC(Map<String, String> sParaTemp) {
        //待请求参数数组
        Map<String, String> sPara = buildRequestPara(sParaTemp);
        List<NameValuePair> params_list = new ArrayList<NameValuePair>();
        //进行POST的组装
        ...
        if(params_list.size() > 0){
            return doGet(ALIPAY_GATEWAY_PC,params_list.toArray(params));
        }
	...
	public static  String doGet(String url,NameValuePair[] params){
		...
		try{
			...
			if(params!= null){
				...
				log.info("QueryString="+get.getQueryString());
			}
