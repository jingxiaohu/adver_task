...
public class MessageTest extends BaseWebTest {
     ...
     * 2.0 获取用户自己发的帖子列表例子：
     * <pre>
     *     {"data":[{"mi_address":"","mi_app":0,"mi_area":1,"mi_content":"看炒股基础知识 安逸","mi_createtime":1464107070113,"mi_flag":0,"mi_gis":"","mi_id":99,"mi_image":"http://app.51pyb.com/file/img/msg/2016/head2_31560.jpg,http://app.51pyb.com/file/img/msg/2016/head2_94797.jpg","mi_latlng":"","mi_link_id":0,"mi_model":"android","mi_order":0,"mi_pl_count":1,"mi_read_count":13,"mi_title":"夜猫子","mi_type":"0","mi_uptime":1464112293472,"mi_zan":2,"note":"","ui_id":2},{"mi_address":"","mi_app":0,"mi_area":1,"mi_content":"活到老学到老","mi_createtime":1462688117380,"mi_flag":0,"mi_gis":"","mi_id":74,"mi_image":"http://app.51pyb.com/file/img/msg/2016/head2_97415.jpg","mi_latlng":"","mi_link_id":0,"mi_model":"android","mi_order":0,"mi_pl_count":1,"mi_read_count":5,"mi_title":"学而时习之","mi_type":"0","mi_uptime":1464092826170,"mi_zan":1,"note":"","ui_id":2},{"mi_address":"","mi_app":0,"mi_area":1,"mi_content":"终于凉快了","mi_createtime":1462497730065,"mi_flag":0,"mi_gis":"","mi_id":70,"mi_image":"http://app.51pyb.com/file/img/msg/2016/head2_20439.jpg","mi_latlng":"","mi_link_id":0,"mi_model":"android","mi_order":0,"mi_pl_count":0,"mi_read_count":3,"mi_title":"今天天气好","mi_type":"0","mi_uptime":0,"mi_zan":0,"note":"","ui_id":2},{"mi_address":"","mi_app":0,"mi_area":1,"mi_content":"炒股挣钱主要是要有重要的股票信息，股掌为您起航！","mi_createtime":1461165764189,"mi_flag":0,"mi_gis":"","mi_id":1,"mi_image":"http://app.51pyb.com/file/img/msg/2016/head2_21354.jpg","mi_latlng":"","mi_link_id":0,"mi_model":"android","mi_order":0,"mi_pl_count":2,"mi_read_count":12,"mi_title":"开始学炒股","mi_type":"0","mi_uptime":1467452084877,"mi_zan":3,"note":"","ui_id":2}],"errorcode":"","errormsg":"","errorno":"0"}
     * </pre>
     */
    @Test
    public void messagelist() throws Exception {
        ...
        MvcResult mvcResult = mockMvc.perform(post("/v1/messagelist").params(params))
                .andExpect(status().isOk()).andReturn();
        String result = mvcResult.getResponse().getContentAsString();
        System.err.println(result);
        String path = this.getClass().getResource(".").getPath();
        path = path + "Message.md";
        InterfaceUtil.AddInterfacePred(path, moduleName, "获取用户自己发的帖子列表例子",
                "dtype+ui_id", "/v1/messagelist", 2,
                params, Param_my_messageList.class, result);
    }
    /**
     * 1.0获取直播消息例子：
     * <pre>
