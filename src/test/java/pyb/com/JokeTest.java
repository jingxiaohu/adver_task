 ...
 * joke测试
 */
public class JokeTest extends BaseWebTest {
    public String moduleName = "笑话管理模块";
    /**
     * 1.0 获取笑话分类列表例子：
     * <pre>
     *     {"data":[{"jc_id":1,"name":"爆笑男女","is_show":1,"ctime":1462435279000,"jc_count":22044},{"jc_id":2,"name":"冷笑话","info":"冷笑话","is_show":1,"ctime":1462435296000,"jc_count":3723,"note":""},{"jc_id":6,"name":"校园笑话","info":"校园笑话","is_show":1,"ctime":1463069610000,"jc_count":985,"note":"校园笑话"},{"jc_id":7,"name":"爆笑笑话","info":"爆笑笑话","is_show":1,"ctime":1463075199000,"jc_count":1760,"note":"爆笑笑话"},{"jc_id":8,"name":"经典段子","info":"经典段子","is_show":1,"ctime":1463076372000,"jc_count":3912,"note":"经典段子"},{"jc_id":9,"name":"内涵笑话","info":"内涵笑话","is_show":1,"ctime":1463110543000,"jc_count":6810,"note":"内涵笑话"},{"jc_id":10,"name":"捧腹段子","info":"捧腹段子","is_show":1,"ctime":1463128606000,"jc_count":133724,"note":"捧腹段子"}],"errorcode":"","errormsg":"","errorno":"0"}
     * </pre>
     */
    @Test
    public void jokeclass() throws Exception {
        MultiValueMap<String, String> params = getParams();
        sign(params, "dtype");

        MvcResult mvcResult = mockMvc.perform(post("/v1/jokeclass").params(params))
